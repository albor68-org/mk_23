...
void setup_LEDS() {
    ...
    gpio_mode_setup(GPIOE, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, GPIO8 | GPIO10 | GPIO12 | GPIO14);
}
void setup_timer() {
//Настройка таймера
    //"Разморозка" таймера
...
void tim6_dac_isr() {
    ...
    gpio_toggle(GPIOE, GPIO8 | GPIO10 | GPIO12 | GPIO14);
